...
export function transformEvent(e) {
  ...
  return {
    ...
    organizer: { id: e.organizer_id, name: "Organizer" },
...
export function transformEventList(e) {
  ...
  const tiers = t
    ? [{ id: null, name: t.tier_name, price: parseFloat(t.price), remaining: t.quantity_remaining, quantity: t.quantity_remaining }]
    : [];
  return {
    id: e.id,
    title: e.title,
